 ...
 * 
 * @author ken
 * @date 2014-10-25 下午2:14:24
 * @version v1.0
 * 
 * @cause 实盘版本添加前端生成控制并发使用的id
 * @modifier minigod
 * @date 2015-03-09 下午9:04:06
 * @version v2.0
 */
...
public class SNVersion implements Serializable {
	...
	//请求来源,minigod證券國際PC版调用src=PC，APP调用为空（默认APP），WEB调用src=WEB(后续可扩展)
	private String src;
	// 官网用户登录凭证
