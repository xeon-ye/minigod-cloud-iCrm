 ...
 * @version v1.0
 */
public class StkMoneyFlow implements Serializable {

	private static final long serialVersionUID = 1L;

	private String assetId; //资产ID
	private long ts; //时间
	private Double largeOrderIn=0d; // 流入大单金额
	private Double midOrderIn=0d; // 流入中单金额
	private Double smallOrderIn=0d; // 流入小单金额
	private Double largeOrderOut=0d; // 流出大单金额
	private Double midOrderOut=0d; // 流出中单金额
	private Double smallOrderOut=0d; // 流出小单金额
	private Double totalIn=0d; // 流入净额
	private Double totalOut=0d; // 流出净额
