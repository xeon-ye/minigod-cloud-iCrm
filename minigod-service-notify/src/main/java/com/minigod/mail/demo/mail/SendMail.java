...
import com.minigod.mail.model.AddressListReceiver;
import com.minigod.mail.model.SendCloudMail;
import com.minigod.mail.model.TemplateContent;
...
public class SendMail {
	...
	public static void send_common() throws Throwable {
		...
		// 添加收件人
		receiver.addTo("kouyandong@163.com");
		// 添加抄送
		receiver.addCc("developer@zszhizhu.com");
		// 添加密送
		receiver.addBcc("");

		MailBody body = new MailBody();
		// 设置 From
		body.setFrom("jim@zszhizhu.com");
		// 设置 FromName
		body.setFromName("宝新证券");
		// 设置 ReplyTo
		body.setReplyTo("developer@zszhizhu.com");
		// 设置标题
		body.setSubject("来自 宝新证券  的邮件");
		// 创建文件附件
		body.addAttachments(new File("/Users/kk/Downloads/viewfile.png"));
		//// 创建流附件
