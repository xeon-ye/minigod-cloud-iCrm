...
public class VerifyJFSzcaServiceImpl extends BaseBeanFactory implements VerifyJFSzcaService {
    ...
    private String JF_SZCA_USER_NAME;

    @Value("${minigod.jfszca.userPwd}")
    private String JF_SZCA_USER_PWD;

    @Value("${minigod.jfszca.url}")
    private String JF_SZCA_API_URL;
    ...
    @PostConstruct
    private void init() {
        URL_LOGIN = JF_SZCA_API_URL + API_LOGIN;
        URL_GET_TOKEN = JF_SZCA_API_URL + API_GET_TOKEN;
        URL_GET_CERT = JF_SZCA_API_URL + API_GET_CERT;
        URL_GET_CERT_APPLY_P10 = JF_SZCA_API_URL + API_GET_CERT_APPLY_P10;
        URL_GET_SIGN_P7_FOR_PDF = JF_SZCA_API_URL + API_GET_SIGN_P7_FOR_PDF;
        URL_GET_PDF_INFO_FOR_SIGN = JF_SZCA_API_URL + API_GET_PDF_INFO_FOR_SIGN;
    }
    ...
    public VerifySzcaPojo login() {
        ...
        reqVo.setUserAccount(JF_SZCA_USER_NAME);
        reqVo.setUserPwd(JF_SZCA_USER_PWD);
