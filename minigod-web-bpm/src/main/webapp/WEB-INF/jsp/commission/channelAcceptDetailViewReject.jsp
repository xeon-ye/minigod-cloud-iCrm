        ...
        <table width="40%" align="center" valign="center" border="0px">
            ...
            <tr>
                <td>
                    ...
                    <div class="col-xs-3">
                        <input type="text" value="${fareKindInfo.parentName}"
                               class="form-control">
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    <div class="col-xs-3">
                        <input type="text" name="" style="width:80%;display: inline" value="${fareKindInfo.fareKind}"
                               class="form-control">
                        <i v-show="icon" id="iconTips" class="layui-icon" style="font-size: 20px; color: #4caf50;">
                            &#xe607;</i>
                    </div>
                </td>
            </tr>
            ...
            <c:if test="${nextFareKindInfo!=null}">
                ...
                <tr>
                    <td>
                        ...
                        <div class="col-xs-3">
                            <input type="text" style="width:80%;display: inline" name=""
                                   value="${nextFareKindInfo.fareKind}" class="form-control">
                            <i v-show="icon" id="nextIconTips" class="layui-icon"
...
<script>
    ...
    function flowEnd(busId, taskId, defId, instanceId) {
        ...
        var url = "${webRoot}/channelFareSetupLog/reject";
