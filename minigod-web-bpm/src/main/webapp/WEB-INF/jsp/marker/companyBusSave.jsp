...
<div id="div0" v-cloak>
    <div v-show="!showList" class="panel panel-default" style="text-align: center;   width: 99.9%">
        <div class="panel-heading"><b style="color: #368763">业务人员信息新增</b></div>
        </br>
                ...
                <table width="99%" height="85%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="col-xs-5 ">
                                <tag:select id="personnelRole" name="personnelRole" nameKey="SEC_PERSONNEL_ROLE" isAddDefaltOption="true" initSelectedKey="${info.personnelRole}"></tag:select>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <label class="layui-form-label" style="width: 180px">电子邮箱：</label>
                            <div class="col-xs-5">
...
<script>
    ...
    function doSaveOrUpdate() {
        ...
        var email = $("#email").val();
        var url = "${webRoot}/companyBusinessPersonnel/save";
        $.ajax({
            url: url,   //处理页面的名称
            data: {
                id: id,
