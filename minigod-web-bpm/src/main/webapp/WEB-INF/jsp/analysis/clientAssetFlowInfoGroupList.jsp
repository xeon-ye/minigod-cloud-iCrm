    ...
    <div class="" style="margin-top: 20px;">
        <shiro:hasPermission name="channelBatch:qry">
            <form class="layui-form" id="search-from" method="post"
                  action="${webRoot}/clientAssetFlowInfo/getClientAssetFlowInfoGroupList">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;&nbsp;
                                ...
                                <shiro:hasPermission name="assetGroupListExpExcel:exp">
                    ...
                    <tr name="customer_${clientAssetFlowInfoList.id }">
                        ...
                        <td>
                            <a href="javascript:void(0);" style="display: block;color: blue"
                               onclick="goCountGraphic('${clientAssetFlowInfoList.clientId}','${clientAssetFlowInfoList.fundAccount}','${clientAssetFlowInfoList.tradeDate}');">
                                    ${clientAssetFlowInfoList.fundAccount}</a>
                        </td>
...
//        layer.alert(obj);
        window.location.href = '${webRoot}/clientAssetFlowInfo/assetGroupListExpExcel?clientAssetFlowInfoEntity=&' + obj;
    }

    function goCountGraphic(clientId, fundAccount, tradeDate) {
        var url = "${webRoot}/clientAssetFlowInfo/goCountGraphic?dateType=1&clientId=" + clientId + "&fundAccount=" + fundAccount + "&tradeDate=" + tradeDate;
        // 弹框层
        layer.open({
            scrollbar: false,
            type: 2,
