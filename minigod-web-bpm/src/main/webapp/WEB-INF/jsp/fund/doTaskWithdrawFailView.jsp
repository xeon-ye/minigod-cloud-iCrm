...
<div class="main-container" id="main-container">
    ...
    <div id="div7" v-cloak>
        <div v-show="!showList" class="panel panel-default">
            <div class="panel-heading"><b style="color: #368763">汇款失败原因</b></div>

            <div style="margin-left: 5%;width: 90%;height: 200px;">

                <c:forEach var="codeEntity" items="${fundWithdrawFailTypes}" varStatus="i">
...
<script>
    ...
    function doSubmit() {
        ...
        confirm("确认提交吗?", function () {
            ...
            var url = "${webRoot}/clientFundWithdraw/doWithdrawFail";
