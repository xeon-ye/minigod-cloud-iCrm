...
<div class="main-container" id="main-container">
    <div class="" style="margin-top: 10px;">
        <form class="layui-form" id="search-from" method="post" action="${webRoot}/customer/list/">
            ...
            <div class="layui-inline" style="margin-bottom: 2px;">
                ...
                <div class="layui-input-block">
                    <tag:select initSelectedKey="${queryCondition.applicationStatus}" nameKey="AO_OPEN_ACCOUNT_STATUS"
                                name="applicationStatus" isAddDefaltOption="true" initDidableKey="13"></tag:select>
                </div>
    ...
    <div class="col-sm-12" style="width:99%">
        <table id="table-list" class="layui-table" lay-size="">
            ...
            <c:forEach items="${page.result}" var="info" varStatus="i">
                <tr>
                    <td>
                        <c:if test="${info.customerAccountOpenApplyEntity.applicationStatus == 2 || info.customerAccountOpenApplyEntity.applicationStatus == 3}">
...
<script>
    ...
    function exportExcel() {
        ...
        window.location.href = '${webRoot}/customer/openAcctListExp?AccountOpenApplyQuery=&' + obj;
    }
