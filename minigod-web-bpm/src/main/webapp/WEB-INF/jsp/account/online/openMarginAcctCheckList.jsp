...
<div class="main-container" id="main-container">
    <div class="row" style="margin-top: 10px;">
        <div class="col-md-12">
            <form class="layui-form" id="search-from" action="${webRoot}/customer/checkMarginList">
            ...
            <table id="table-list" class="layui-table" lay-size="">
                ...
                <c:forEach items="${page.result}" var="info" varStatus="i">
                    <tr id="application_${info.customerAccountOpenInfoEntity.id }" <c:if
                            test="${info.customerAccountMarginOpenApplyEntity.fireAid == 1}"> style="color: red" </c:if>   >
                        <td>${info.customerAccountMarginOpenApplyEntity.applicationId}</td>
                        <td><fmt:formatDate value="${info.customerAccountMarginOpenApplyEntity.createTime}"
                        ...
                        <td>
                            <div class=" btn-group ">
                                <c:if test="${info.customerAccountMarginOpenApplyEntity.assignDrafter == null or info.customerAccountMarginOpenApplyEntity.assignDrafter == '' }">
                                    <button class="layui-btn layui-btn-small" type="button"
                                            onclick="applyTask('${info.customerAccountMarginOpenApplyEntity.applicationId}','${currentUserId}')">
...
<script>
    ...
    function applyTask(applicationIds, currentUserId) {
        ...
        confirm("您确定申领此业务吗?", function () {
            ...
            var params = {
                ...
                'actKey': 'customerAccountMarginOpenApplication'
            };
            var url = "${webRoot}/customer/applyMarginTaskHandleBatch";
    ...
    function doTaskTab(actKey, busId, instanceId, taskId, defid, nodeType, dealId, taskName, bankType, applicationStatus) {
        ...
        var title = "<a><strong>开户管理-账户增开-" + applicationStatus + "-" + bankType + "</strong></a>";
    ...
    layui.use('form', function () {
        ...
        form.on('radio(filter)', function (data) {
            ...
            window.location.href = "${webRoot}/customer/checkMarginList?params=" + params;
