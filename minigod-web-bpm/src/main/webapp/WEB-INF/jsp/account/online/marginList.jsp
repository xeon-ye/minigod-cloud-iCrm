...
<div class="main-container" id="main-container">
    <div class="" style="margin-top: 10px;">
        <form class="layui-form" id="search-from" method="post" action="${webRoot}/customer/marginList/">
                            ...
                            <c:when test="${info.customerAccountOpenInfoEntity.openAccountType == 2}">
                                <button class="layui-btn layui-btn-mini" type="button"
                                        onclick="doTaskTab('customerAccountOpenApplicationOffline','${info.customerAccountOpenInfoEntity.applicationId}',
                                                '${info.customerAccountMarginOpenApplyEntity.instanceId}','','${info.customerAccountMarginOpenApplyEntity.defid}','','${info.customerAccountMarginOpenApplyEntity.assignDrafter}','${info.customerAccountMarginOpenApplyEntity.currentNode}');">
