package com.sunline.modules.common.form.checkbox;
...
public class RadioTag extends SimpleTagSupport {
    ...
    /**自定义属性*/
    private String initCheckKey;//设置单选框选中项的key（1,2）
    private String initDidableKey;//（值）设置单选框不包含该值 （1,2）
    private String initCludeKey;//（值）设置单选框包含值 （1,2）
    ...
    public void doTag()throws JspException,IOException {
        ...
        sbcommon.append("<span  ><input  type='radio' ");
        ...
        try {
            if(StringUtils.hasText(nameKey)||(isJXdata!=null&&isJXdata)){
                //单选框值不能有的值 集合
                Map<String,String> disableMap= Maps.newHashMap();
                ...
                //单选框值只能有的值 集合
                Map<String,String> cludeMap=Maps.newHashMap();
...
//					Map<String,Map<String,Object>> allCodeMap= CodeCache.get(Constant.CODE_CACHE);
                ...
                if(childs!=null&&childs.size()>0){
                    for (Map<String,Object> option : childs) {
                        ...
                        sb.append("/>").append(value).append("<span style='width:10px;'>&nbsp;&nbsp;&nbsp;</span></span>");
                    }
                }
            }
            ...
            out.write("<font color='red'>加载radio失败</font>");
        }
    }
