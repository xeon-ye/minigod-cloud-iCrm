 ...
 */
package com.sunline.modules.common.page;
...
public class Page<T> {
	...
	@Override  
 	public String toString() {
		...
		sb.append("<span class=\"pagination-info\">显示第 <strong>"+startNum+"</strong> 到第 <strong>"+ endRow +"</strong> 条记录，总共 <strong>"+total+"</strong> 条记录</span>");
		sb.append("<span class=\"page-list\">，每页显示 <span class=\"dropup\"><strong>"+pageSize);//btn-white btn-group
...
// 		sb.append("</ul>");
		sb.append("</strong></span> 条记录</span>");
		sb.append("</div>");
