...
public final class DateConverUtil {
	...
	/**
	 * 获取指定日期date的后index天的时间，当前时间 2017-10-25 15:08:20 index=1时得到下一天开始时间 2017-10-26 00:00:00
	 * @return
	 */
	public static Date getCalculateTime(Date date ,int index ) {
		Calendar calendar = Calendar.getInstance();
...
//		calendar.set(Calendar.SECOND, 0);
	...
	public static void main(String[] args) {
		Date date = new Date();
		Date nextDate = getCalculateTime(date,5);
