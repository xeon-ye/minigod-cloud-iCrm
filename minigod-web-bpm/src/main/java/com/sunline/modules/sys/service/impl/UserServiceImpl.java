...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<UserEntity> queryByRoleId(String roleId) {
        DataSourceContextHolder.setDataSourceType(DataSourceEnum.DATA_SOURCE_MASTER);
     ...
     */
    @Override
    public List<String> queryChannelIds(UserEntity user) {
        DataSourceContextHolder.setDataSourceType(DataSourceEnum.DATA_SOURCE_MASTER);
        return userDao.queryChannelIds(user);
    }
    ...
    public Map<String, List<String>> queryBapidByUserId(String userId) {
        ...
        Map<String,List<String>> bapidMap = Maps.newHashMap();
    ...
    public Map<String, List<String>> queryBaidByUserId(String userId) {
        ...
        Map<String,List<String>> baidMap = Maps.newHashMap();
        for (Map<String,Object> map:maps){
...
//        }
    ...
    @Override
    public List<String> queryRoleName(String id) {
        DataSourceContextHolder.setDataSourceType(DataSourceEnum.DATA_SOURCE_MASTER);
        return userDao.queryRoleName(id);
    }
}
