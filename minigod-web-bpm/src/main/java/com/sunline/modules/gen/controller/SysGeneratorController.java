package com.sunline.modules.gen.controller;
...
import com.sunline.modules.common.xss.XssHttpServletRequestWrapper;
...
public class SysGeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.reset();  
        response.setHeader("Content-Disposition", "attachment; filename=\"cubp-generator-file.zip\"");
