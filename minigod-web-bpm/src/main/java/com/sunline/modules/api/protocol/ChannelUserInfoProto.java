...
/**
 * @description: 渠道用户中心请求协议
 * @author: lidh
 * @date: 2019/05/06
 */
public class ChannelUserInfoProto extends BaseParameter {
    ...
    public String toString() {
        return "SecuritiesUserInfoProto{" +
                "id=" + id +
                ", applicationId='" + applicationId + '\'' +
                ", openAccountType=" + openAccountType +
                ", openAccountAccessWay=" + openAccountAccessWay +
                ...
                ", givenName='" + givenName + '\'' +
                ", clientNameSpell='" + clientNameSpell + '\'' +
                ", openAccountStartTime=" + openAccountStartTime +
                ", openAccountEndTime=" + openAccountEndTime +
