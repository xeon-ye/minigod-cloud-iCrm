...
import com.sunline.component.redis.CachingShiroSessionDao;
import com.sunline.component.shiro.MyRealm;
...
//        securityManager.setRememberMeManager(null);
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        // 定义过滤器
        Map<String, Filter> filterLoginMap = new LinkedHashMap<>();
//        filterLoginMap.put("authc", new ShiroLoginFilter());
        filterLoginMap.put("perms", new ShiroPermissionsFilter());
        shiroFilter.setFilters(filterLoginMap);
...
//        filterMap.put("/**/*.html", "anon");
        ...
        filterMap.put("/", "anon");
        filterMap.put("/proxy/**", "anon");
        filterMap.put("/bpm_test/*", "anon");
        filterMap.put("/crm_test/*", "anon");
        filterMap.put("/securitiesUserInfo/*", "anon");
        filterMap.put("/channelApi/*", "anon");
        filterMap.put("/crm_api/*", "anon");
        filterMap.put("/bpm_api/*", "anon");
