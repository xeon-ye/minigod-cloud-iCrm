...
public class PinyinHelper {
	...
	public static void main(String[] args) {
		String test="西藏xī,zàng";//   xīzàng 藏族====zàngzú
		System.err.println(string2Unicode(test));
		
		System.out.println(PinyinHelper.convertToPinyinString("厦门", " ", PinyinFormat.WITHOUT_TONE).toUpperCase());
		System.out.println(PinyinHelper.convertToPinyinString("大厦", " ", PinyinFormat.WITHOUT_TONE).toUpperCase());
		System.out.println(PinyinHelper.convertToPinyinString("西藏", " ", PinyinFormat.WITHOUT_TONE).toUpperCase());
		System.out.println(PinyinHelper.convertToPinyinString("藏族", " ", PinyinFormat.WITHOUT_TONE).toUpperCase());
		System.out.println(PinyinHelper.convertToPinyinString("捉迷藏", " ", PinyinFormat.WITHOUT_TONE).toUpperCase());
	}
}
