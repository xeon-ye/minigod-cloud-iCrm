...
public class HttpClientUtils {
    ...
    private static final ThreadLocal<Map<String, SNHttpClient>> threadLocal = new ThreadLocal<Map<String, SNHttpClient>>();
        ...
        if (clients != null && System.currentTimeMillis() - lastCloseTime > interval) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    for (Map.Entry<String, SNHttpClient> en : clients.entrySet()) {
