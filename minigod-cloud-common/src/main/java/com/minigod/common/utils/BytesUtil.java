...
public class BytesUtil {
	...
	public static void main(String[] args) {
		...
		byte[] bb = "1".getBytes();
		//System.err.println(getLong(bb, 32));
		System.err.println(bytes2HexString(bb));
	}
	...
	/**
	 * 将buffer的内容填充至sbuffer中
	 * @param sbuffer
	 * @param buffer
	 * @param index
	 */
	public static void putBytes(byte[] sbuffer, byte[] buffer, int index) {
		System.arraycopy(buffer, 0, sbuffer, index, buffer.length);
	}
	 ...
	 * @param index
	 */
	public static void putZero(byte[] buffer, int index) {
		buffer[index] = 0x00;
	}
}