...
import com.minigod.persist.tables.TPayRbOrder;
 ...
 * 融宝支付订单
 */
@Entity(table=TPayRbOrder.class)
public class PayRbOrder implements Serializable {

	private static final long serialVersionUID = -2260388125919493487L;
	private Integer rbOrderId;//融宝支付订单ID
	...
	private Integer qnUserId;//犇犇用户id
	...
	private String payStatus;//融宝订单状态
	...
	private String cbRbReturn;//融宝回调的传入完整信息
    ...
    public Integer getRbOrderId () {
        return rbOrderId;
    }

    public void setRbOrderId (Integer rbOrderId) {
