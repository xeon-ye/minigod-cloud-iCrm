...
import com.minigod.persist.tables.TPayWxTransfer;
 ...
 * 
 */
@Entity(table=TPayWxTransfer.class)
public class PayWxTransfer implements Serializable {

	private static final long serialVersionUID = -2260388125919493487L;
	private Integer wxTransferId;//微信转账表ID
	...
	private String wxErrMsg;//转账失败信息
	private Boolean isStatus;//记录状态
	private Date createTime;//记录创建时间
	private Date updateTime;//记录修改时间
	private Integer lockVersion;//乐观锁版本号

    public Integer getWxTransferId () {
        return wxTransferId;
    }

    public void setWxTransferId (Integer wxTransferId) {
