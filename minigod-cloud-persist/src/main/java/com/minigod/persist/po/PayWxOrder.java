...
import com.minigod.persist.tables.TPayWxOrder;
 ...
 * 
 */
@Entity(table=TPayWxOrder.class)
public class PayWxOrder implements Serializable {

	private static final long serialVersionUID = -2260388125919493487L;
	private Integer wxOrderId;//微信支付订单ID
	...
	private Integer qnUserId;//齐牛用户id
	...
	private String payStatus;//微信订单状态
	...
	private String wxErrMsg;//订单创建失败信息
	private String cbMethod;//回调的方法识别标志
	private String cbAttach;//附加信息
	private String cbWxReturn;//微信回调的传入完整信息
    ...
    public Integer getQnUserId () {
        return qnUserId;
    }

    public void setQnUserId (Integer qnUserId) {
        this.qnUserId = qnUserId;
    }
    ...
    public String getCbWxReturn () {
        return cbWxReturn;
    }

    public void setCbWxReturn (String cbWxReturn) {
        this.cbWxReturn = cbWxReturn;
    }
