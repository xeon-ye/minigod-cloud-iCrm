...
import com.minigod.persist.tables.TStkTodayOrder;
 ...
 * 
 */
@Entity(table=TStkTodayOrder.class)
public class StkTodayOrder implements Serializable {
	...
	private Double cancelqty = 0.0000d;
