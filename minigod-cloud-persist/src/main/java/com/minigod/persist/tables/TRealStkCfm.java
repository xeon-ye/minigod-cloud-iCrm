...
public class TRealStkCfm extends AbstractTable {
	...
	private TRealStkCfm(){
		super.tableName = "real_stk_cfm";
	}

	private TRealStkCfm(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TRealStkCfm getInstance() {
		return new TRealStkCfm();
	}

	public static final TRealStkCfm getInstance(String aliasName) {
		return new TRealStkCfm(aliasName);
	}
	...
	public String toString() {
		return "TRealStkCfm[table=real_stk_cfm]";
	}
}
