...
public class TGrmTrdFundJour extends AbstractTable {

	static {
		init();
	}

	private TGrmTrdFundJour(){
		super.tableName = "grm_trd_fund_jour";
	}

	private TGrmTrdFundJour(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TGrmTrdFundJour getInstance() {
		return new TGrmTrdFundJour();
	}

	public static final TGrmTrdFundJour getInstance(String aliasName) {
		return new TGrmTrdFundJour(aliasName);
	}
	...
	private final TableField<?>[] allFields = new TableField<?>[] {jourId,currDate,clientId,fundAccount,moneyType,businessFlag,occurBalance,valueDate,bankId,bankAccount,extPositionStr,extSerialNo,remark,initDate};
	...
	public String toString() {
		return "TGrmTrdFundJour[table=grm_trd_fund_jour]";
	}
}
