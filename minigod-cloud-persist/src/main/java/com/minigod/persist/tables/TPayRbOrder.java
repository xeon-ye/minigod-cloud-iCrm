...
public class TPayRbOrder extends AbstractTable {
	...
	private TPayRbOrder(){
		super.tableName = "pay_rb_order";
	}

	private TPayRbOrder(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TPayRbOrder getInstance() {
		return new TPayRbOrder();
	}

	public static final TPayRbOrder getInstance(String aliasName) {
		return new TPayRbOrder(aliasName);
	}

	private static Map<String, String> allFieldMap;
	private static final void init() {
		allFieldMap = new HashMap<String, String>();
		allFieldMap.put("rbOrderId", "rb_order_id");
	 ...
	 * 融宝支付订单ID | int(11)
	 */
	public final TableField<Integer>  pk = new TableFieldImpl<Integer>(this,"rb_order_id","rbOrderId","融宝支付订单ID");

	/**
	 * 乐观锁字段
	 */
	public final TableField<Integer>  lock = new TableFieldImpl<Integer>(this,"lock_version","lockVersion","融宝支付订单ID");

	public final TableField<Integer> rbOrderId = new TableFieldImpl<Integer>(this,"rb_order_id","rbOrderId","融宝支付订单ID");
	 ...
	 * 犇犇用户id | int(11)
	 */
	public final TableField<Integer> qnUserId = new TableFieldImpl<Integer>(this,"qn_user_id","qnUserId","犇犇用户id");
	 ...
	 * 融宝订单状态 | char(1)
	 */
	public final TableField<String> payStatus = new TableFieldImpl<String>(this,"pay_status","payStatus","融宝订单状态");
	...
	/**
	 * 融宝回调的传入完整信息 | varchar(5120)
	 */
	public final TableField<String> cbRbReturn = new TableFieldImpl<String>(this,"cb_rb_return","cbRbReturn","融宝回调的传入完整信息");
	...
	private final TableField<?>[] allFields = new TableField<?>[] {rbOrderId,srcSys,srcBus,srcTransId,md5,accountId,qnUserId,feeType,totalFee,display,incomeOrExpense,des,detail,finishStatus,payStatus,cbStatus,actStatus,transactionId,frzAmt,refundAmt,mchId,billCreateIp,timeStart,timeExpire,tradeType,limitPay,prepayId,wxErrMsg,cbMethod,cbAttach,cbRbReturn,cbTryTime,cbErrMsg,remark,isStatus,createTime,updateTime,lockVersion};
	...
	public String toString() {
		return "TPayRbOrder[table=pay_rb_order]";
	}
}
