...
public class TSimuStkCfm extends AbstractTable {
	...
	private TSimuStkCfm(){
		super.tableName = "simu_stk_cfm";
	}

	private TSimuStkCfm(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TSimuStkCfm getInstance() {
		return new TSimuStkCfm();
	}

	public static final TSimuStkCfm getInstance(String aliasName) {
		return new TSimuStkCfm(aliasName);
	}
	...
	public String toString() {
		return "TSimuStkCfm[table=simu_stk_cfm]";
	}
}
