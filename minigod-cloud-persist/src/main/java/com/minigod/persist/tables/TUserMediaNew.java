...
public class TUserMediaNew extends AbstractTable {

	static {
		init();
	}

	private TUserMediaNew(){
		super.tableName = "user_media_new";
	}

	private TUserMediaNew(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TUserMediaNew getInstance() {
		return new TUserMediaNew();
	}

	public static final TUserMediaNew getInstance(String aliasName) {
		return new TUserMediaNew(aliasName);
	}
	...
	public String toString() {
		return "TUserMediaNew[table=user_media_new]";
	}
}
