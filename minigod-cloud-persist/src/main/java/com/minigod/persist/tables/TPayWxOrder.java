...
public class TPayWxOrder extends AbstractTable {
	...
	private TPayWxOrder(){
		super.tableName = "pay_wx_order";
	}

	private TPayWxOrder(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TPayWxOrder getInstance() {
		return new TPayWxOrder();
	}

	public static final TPayWxOrder getInstance(String aliasName) {
		return new TPayWxOrder(aliasName);
	}

	private static Map<String, String> allFieldMap;
	private static final void init() {
		allFieldMap = new HashMap<String, String>();
		allFieldMap.put("wxOrderId", "wx_order_id");
		...
		allFieldMap.put("qnUserId", "qn_user_id");
	 ...
	 * 微信支付订单ID | int(11)
	 */
	public final TableField<Integer>  pk = new TableFieldImpl<Integer>(this,"wx_order_id","wxOrderId","微信支付订单ID");

	/**
	 * 乐观锁字段
	 */
	public final TableField<Integer>  lock = new TableFieldImpl<Integer>(this,"lock_version","lockVersion","微信支付订单ID");

	public final TableField<Integer> wxOrderId = new TableFieldImpl<Integer>(this,"wx_order_id","wxOrderId","微信支付订单ID");
	 ...
	 * 齐牛用户id | int(11)
	 */
	public final TableField<Integer> qnUserId = new TableFieldImpl<Integer>(this,"qn_user_id","qnUserId","齐牛用户id");
	 ...
	 * 微信订单状态 | char(1)
	 */
	public final TableField<String> payStatus = new TableFieldImpl<String>(this,"pay_status","payStatus","微信订单状态");
	 ...
	 * 二维码链接 | varchar(64)
	 */
	public final TableField<String> codeUrl = new TableFieldImpl<String>(this,"code_url","codeUrl","二维码链接");

	/**
	 * 订单创建失败信息 | varchar(128)
	 */
	public final TableField<String> wxErrMsg = new TableFieldImpl<String>(this,"wx_err_msg","wxErrMsg","订单创建失败信息");
	...
	/**
	 * 微信回调的传入完整信息 | varchar(5120)
	 */
	public final TableField<String> cbWxReturn = new TableFieldImpl<String>(this,"cb_wx_return","cbWxReturn","微信回调的传入完整信息");
	...
	private final TableField<?>[] allFields = new TableField<?>[] {wxOrderId,srcSys,srcBus,srcTransId,md5,accountId,qnUserId,feeType,totalFee,display,incomeOrExpense,des,detail,finishStatus,payStatus,cbStatus,actStatus,transactionId,frzAmt,refundAmt,appid,mchId,billCreateIp,timeStart,timeExpire,tradeType,limitPay,openid,prepayId,codeUrl,wxErrMsg,cbMethod,cbAttach,cbWxReturn,cbTryTime,cbErrMsg,remark,isStatus,createTime,updateTime,lockVersion};
	...
	public String toString() {
		return "TPayWxOrder[table=pay_wx_order]";
	}
}
