...
public class TSimuPtfTransHis extends AbstractTable {

	static {
		init();
	}

	private TSimuPtfTransHis(){
		super.tableName = "simu_ptf_trans_his";
	}

	private TSimuPtfTransHis(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TSimuPtfTransHis getInstance() {
		return new TSimuPtfTransHis();
	}

	public static final TSimuPtfTransHis getInstance(String aliasName) {
		return new TSimuPtfTransHis(aliasName);
	}
	...
	public String toString() {
		return "TSimuPtfTransHis[table=simu_ptf_trans_his]";
	}
}
