...
public class TRealPtfTransHis extends AbstractTable {

	static {
		init();
	}

	private TRealPtfTransHis(){
		super.tableName = "real_ptf_trans_his";
	}

	private TRealPtfTransHis(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TRealPtfTransHis getInstance() {
		return new TRealPtfTransHis();
	}

	public static final TRealPtfTransHis getInstance(String aliasName) {
		return new TRealPtfTransHis(aliasName);
	}
	...
	public String toString() {
		return "TRealPtfTransHis[table=real_ptf_trans_his]";
	}
}
