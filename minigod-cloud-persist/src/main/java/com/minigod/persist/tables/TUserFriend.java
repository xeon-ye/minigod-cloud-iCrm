...
public class TUserFriend extends AbstractTable {
	...
	private TUserFriend(){
		super.tableName = "user_friend";
	}

	private TUserFriend(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TUserFriend getInstance() {
		return new TUserFriend();
	}

	public static final TUserFriend getInstance(String aliasName) {
		return new TUserFriend(aliasName);
	}
	...
	public String toString() {
		return "TUserFriend[table=user_friend]";
	}
}
