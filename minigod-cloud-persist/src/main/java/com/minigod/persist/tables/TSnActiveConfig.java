...
public class TSnActiveConfig extends AbstractTable {

	static {
		init();
	}

	private TSnActiveConfig(){
		super.tableName = "sn_active_config";
	}

	private TSnActiveConfig(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TSnActiveConfig getInstance() {
		return new TSnActiveConfig();
	}

	public static final TSnActiveConfig getInstance(String aliasName) {
		return new TSnActiveConfig(aliasName);
	}
	...
	public String toString() {
		return "TSnActiveConfig[table=sn_active_config]";
	}
}
