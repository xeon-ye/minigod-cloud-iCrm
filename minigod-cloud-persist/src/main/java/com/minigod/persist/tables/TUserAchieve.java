...
public class TUserAchieve extends AbstractTable {

	static {
		init();
	}

	private TUserAchieve(){
		super.tableName = "user_achieve";
	}

	private TUserAchieve(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TUserAchieve getInstance() {
		return new TUserAchieve();
	}

	public static final TUserAchieve getInstance(String aliasName) {
		return new TUserAchieve(aliasName);
	}
	...
	private final TableField<?>[] allFields = new TableField<?>[] {userAchieveId,userId,featId,level,featValue,createTime,updateTime};
	...
	public String toString() {
		return "TUserAchieve[table=user_achieve]";
	}
}
