...
public class TRealStkOrd extends AbstractTable {
	...
	private TRealStkOrd(){
		super.tableName = "real_stk_ord";
	}

	private TRealStkOrd(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TRealStkOrd getInstance() {
		return new TRealStkOrd();
	}

	public static final TRealStkOrd getInstance(String aliasName) {
		return new TRealStkOrd(aliasName);
	}
	...
	public String toString() {
		return "TRealStkOrd[table=real_stk_ord]";
	}
}
