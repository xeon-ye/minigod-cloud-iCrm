...
public class TSimuStkOrdHis extends AbstractTable {

	static {
		init();
	}

	private TSimuStkOrdHis(){
		super.tableName = "simu_stk_ord_his";
	}

	private TSimuStkOrdHis(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TSimuStkOrdHis getInstance() {
		return new TSimuStkOrdHis();
	}

	public static final TSimuStkOrdHis getInstance(String aliasName) {
		return new TSimuStkOrdHis(aliasName);
	}
	...
	public String toString() {
		return "TSimuStkOrdHis[table=simu_stk_ord_his]";
	}
}
