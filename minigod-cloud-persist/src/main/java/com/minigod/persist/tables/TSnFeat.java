...
public class TSnFeat extends AbstractTable {
	...
	private TSnFeat(){
		super.tableName = "sn_feat";
	}

	private TSnFeat(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TSnFeat getInstance() {
		return new TSnFeat();
	}

	public static final TSnFeat getInstance(String aliasName) {
		return new TSnFeat(aliasName);
	}
