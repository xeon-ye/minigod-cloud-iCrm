...
public class TUserCert extends AbstractTable {
	...
	private TUserCert(){
		super.tableName = "user_cert";
	}

	private TUserCert(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TUserCert getInstance() {
		return new TUserCert();
	}

	public static final TUserCert getInstance(String aliasName) {
		return new TUserCert(aliasName);
	}
	...
	public String toString() {
		return "TUserCert[table=user_cert]";
	}
}
