...
public class TUserProgress extends AbstractTable {

	static {
		init();
	}

	private TUserProgress(){
		super.tableName = "user_progress";
	}

	private TUserProgress(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TUserProgress getInstance() {
		return new TUserProgress();
	}

	public static final TUserProgress getInstance(String aliasName) {
		return new TUserProgress(aliasName);
	}
	...
	/**
	 * 领取金币的状态(0:不可领取, 1:可以领取,但尚未领取, 2:可以领取,且已经领取) | int(11)
	 */
	public final TableField<Integer> receiveStatus = new TableFieldImpl<Integer>(this,"receive_status","receiveStatus","领取金币的状态(0:不可领取, 1:可以领取,但尚未领取, 2:可以领取,且已经领取)");
	...
	public String toString() {
		return "TUserProgress[table=user_progress]";
	}
}
