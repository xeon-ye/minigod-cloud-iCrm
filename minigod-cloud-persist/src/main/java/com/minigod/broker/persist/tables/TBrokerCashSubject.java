...
public class TBrokerCashSubject extends AbstractTable {

	static {
		init();
	}

	private TBrokerCashSubject(){
		super.tableName = "broker_cash_subject";
	}

	private TBrokerCashSubject(String aliasName){
		this();
		setAliasName(aliasName);
	}

	public static final TBrokerCashSubject getInstance() {
		return new TBrokerCashSubject();
	}

	public static final TBrokerCashSubject getInstance(String aliasName) {
		return new TBrokerCashSubject(aliasName);
	}
	...
	private final TableField<?>[] allFields = new TableField<?>[] {subjectId,name,direction,isStatus,createTime,updateTime};
	...
	public String toString() {
		return "TBrokerCashSubject[table=broker_cash_subject]";
	}
}
