 ...
 * @author PENGFENG
 * @createDate 2017/2/8
 * @description 开户预约申请协议
 */

@Data
@ToString
public class OpenAccountAppointmentPojo implements Serializable {
    ...
    private List<OpenAccountPropertyTypePojo> propertyType;
    ...
    private List<OpenAccountTaxationInfoPojo> taxationInfo;

    //其他信息披露
    @JSONField(name = "otherDisclosure")
    private List<OpenAccountOtherDisclosurePojo> otherDisclosure;

    //四要素
    @JSONField(name = "bankVerityInfo")
    private List<OpenAccountBankVerityInfoPojo> bankVerityInfo;
    ...
    private List<OpenAccountImageInfoPojo> openAccountImagesInfo;
