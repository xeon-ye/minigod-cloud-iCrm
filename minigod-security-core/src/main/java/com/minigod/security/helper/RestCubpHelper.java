...
public class RestCubpHelper {
    ...
    public CubpSecurityUserInfoResVo selectSecuritiesUserInfo(CubpUserInfoReqVo reqVo) {
        return getResult(QUERY_USERINFO_OBJ, reqVo, CubpSecurityUserInfoResVo.class);
    }
