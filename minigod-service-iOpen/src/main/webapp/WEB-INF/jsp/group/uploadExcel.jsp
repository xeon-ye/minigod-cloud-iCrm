            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="${webRoot}/clientGroupMemberInfo/clientImportExcle" name="uploadForm"
                              id="uploadForm"
                              method="post"
                                    ...
                                    <tr>
                                        <td style="text-align: center;padding-top: 10px;">
                                            <a class="btn btn-mini btn-success"
                                               onclick="window.location.href='${webRoot}/clientGroupMemberInfo/downExcel'">下载模版</a>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajaxFileUpload({
            url: '${webRoot}/clientGroupMemberInfo/clientImportExcle',
            data : {
                groupNo:groupNo
            },
            secureuri: false,
