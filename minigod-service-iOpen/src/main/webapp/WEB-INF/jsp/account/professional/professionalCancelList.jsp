    ...
    <div v-show="showList">
        <div class="" style="margin-top: 20px;">
            <form class="layui-form" id="search-from">
                <input id="flag" name="flag" value="2" hidden>
...
<script>
    ...
    $(function () {
        $("#jqGrid").jqGrid({
            url: '${webRoot}/professionalInvestor/listCancel',
            datatype: "json",
            colModel: [
                ...
                , {
                    ...
                    formatter: function cLink(cellvalue, options, rowObject) {
                        var clik = "cancelTab('" + rowObject.applicationId + "','" + rowObject.instanceId + "','" + rowObject.defid + "','" + rowObject.assignDrafter + "')";
...
//            }
    ...
    function cancelTab(busId, instanceId, defid, dealId) {

        var url = "${webRoot}/act/deal/flowInfoTab?flag=3&actKey=professionalApplication" + "&busId=" + busId + "&instanceId=" + instanceId
