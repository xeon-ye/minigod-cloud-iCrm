...
<div class="main-container" id="main-container">
    <div class="row" style="margin-top: 10px;">
        <div class="col-md-12">
            <form class="layui-form" id="search-from" action="${webRoot}/offlineCustAccOpen/checkList">
                ...
                <div class="layui-inline" style="margin-bottom: 2px;">
                    <label class="layui-form-label" >银行账户类型:</label>
                    <div class="layui-input-block">
                        <tag:select nameKey="NO_BANK_TYPE" name="bankType" initSelectedKey="${queryCondition.bankType}"
                                    clazz="layui-input" isAddDefaltOption="true"/>
                    </div>
                ...
                <c:forEach items="${page.result}" var="info" varStatus="i">
                    <tr id="application_${info.customerAccountOpenInfoEntity.id }" <c:if
                        ...
                        <td><fmt:formatDate value="${info.customerAccountOpenInfoEntity.applicationTime}"
                            ...
                            <%--<td>${fns:getCodeName("NO_BANK_TYPE",info.customerAccountOpenInfoEntity.bankType)}</td>--%>
                        ...
                        <td>
                            <div class=" btn-group ">
                                ...
                                <c:if test="${info.customerAccountOpenApplyEntity.assignDrafter == currentUserId}">
                                    <button class="layui-btn layui-btn-small" type="button"
                                            onclick="doTaskTab('customerAccountOpenApplicationOffline','${info.customerAccountOpenInfoEntity.applicationId}','${info.customerAccountOpenApplyEntity.instanceId}','','${info.customerAccountOpenApplyEntity.defid}',''
...
<script>
    ...
    function applyTask(applicationIds, currentUserId) {
        ...
        confirm("您确定申领此业务吗?", function () {
            var params = {
                ...
                'actKey': 'customerAccountOpenApplicationOffline'
            };
    ...
    function doTaskTab(actKey, busId, instanceId, taskId, defid, nodeType, dealId, taskName, bankType, applicationStatus) {
        ...
        var title = "<a><strong>开户管理-线下开户-" + applicationStatus + "-" + bankType + "</strong></a>";
        //弹框层
        layer.open({
            scrollbar: false,
            type: 2,
    ...
    layui.use('form', function () {
        ...
        form.on('radio(filter)', function (data) {
            ...
            window.location.href = "${webRoot}/offlineCustAccOpen/checkList?params=" + params;
