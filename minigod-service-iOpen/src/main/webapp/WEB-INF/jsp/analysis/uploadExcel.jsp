    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <form action="${webRoot}/moneyRateInfo/moneyRateInfoListImpExcel" name="uploadForm"
                              id="uploadForm"
                              method="post"
                                    ...
                                    <tr>
                                        <td style="text-align: center;padding-top: 10px;">
                                            <a class="btn btn-mini btn-success"
                                               onclick="window.location.href='${webRoot}/moneyRateInfo/downExcel'">下载模版</a>
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $.ajaxFileUpload({
            url: '${webRoot}/moneyRateInfo/moneyRateInfoListImpExcel',
            secureuri: false,
            fileElementId: 'excel',
            dataType: 'text',
