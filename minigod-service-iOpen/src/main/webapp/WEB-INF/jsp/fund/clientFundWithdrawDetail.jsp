...
<div id="div10" v-cloak>
    <div v-show="!showList" class="panel panel-default" >
            ...
            <div class="form-group col-sm-6 col-md-6">
                ...
                <div class="col-xs-9">
                           ...
                           <input id="occurBalance" name="occurBalance" type="text" class="form-control"
                                  value="<fmt:formatNumber value="${info.occurBalance}" pattern="#,##0.00"/>" readonly/>
                            </span>
                </div>
            </div>
        </div>
            ...
            <div class="form-group col-sm-6 col-md-6">
                ...
                <div class="col-xs-9">
                           ...
                           <input id="frozenBalance" name="frozenBalance" type="text" class="form-control"
                                  value="<fmt:formatNumber value="${info.frozenBalance}" pattern="#,##0.00"/>" readonly/>
            ...
            <div class="form-group col-sm-6 col-md-6">
                ...
                <div class="col-xs-9">
                           ...
                           <input id="currentBalance" name="currentBalance" type="text" class="form-control"
                                  value="<fmt:formatNumber value="${info.currentBalance}" pattern="#,##0.00"/>" readonly/>
                            </span>
                </div>
            </div>
        </div>
        ...
        <c:if test="${info.hsBankName != null && info.hsBankAccount!= null}">
            <div class="row">
                <div class="form-group col-sm-6 col-md-6">
                    <label class="col-sm-2 control-label no-padding-right">汇款银行名称</label>
                    <div class="col-xs-9">
	                           <span class="col-sm-12 block input-icon input-icon-right">
	                                <input id="hsBankName" name="hsBankName" type="text" class="form-control"
                                           value="${info.hsBankName}" readonly/>
	                            </span>
                    </div>
                </div>

                <div class="form-group col-sm-6 col-md-6">
                    <label class="col-sm-2 control-label no-padding-right">汇款银行账号</label>
                    <div class="col-xs-9">
                           <span class="col-sm-12 block input-icon input-icon-right">
                           <input id="hsBankAccount" name="hsBankAccount" type="text" class="form-control"
                                  value="${info.hsBankAccount}" readonly/>
                            </span>
                    </div>
                </div>
            </div>
