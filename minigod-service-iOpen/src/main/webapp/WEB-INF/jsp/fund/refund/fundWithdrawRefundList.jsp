...
<div class="main-container" id="main-container">
    <div class="" style="margin-top: 10px;">
        <form class="layui-form" id="search-from" method="post"
              action="${webRoot}/fundWithdrawRefund/list">
            ...
            <div class="layui-inline" style="margin-bottom: 2px;">
                ...
                <div class="layui-input-block">
                    <tag:select id="applicationStatus" name="applicationStatus"
                                nameKey="FUND_WITHDRAW_REFUND_STATUS"
                    ...
                    <tr name="${info.id }">
                        ...
                        <td>
                            <button class="layui-btn layui-btn-mini" type="button"
                                    onclick="viewTab('fundWithdrawRefundApplication','${info.applicationId}','${info.instanceId}','','${info.defid}','','${info.assignDrafter}',0);">
...
//        layer.alert(obj);
        window.location.href = '${webRoot}/fundWithdrawRefund/expList?fundWithdrawRefundApplyEntity=&' + obj;
    }
