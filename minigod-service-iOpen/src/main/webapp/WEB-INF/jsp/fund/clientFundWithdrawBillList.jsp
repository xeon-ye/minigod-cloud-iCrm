...
<div class="main-container" id="main-container">
    <div class="" style="margin-top: 10px;">
        <form class="layui-form" id="search-from" method="post"
              action="${webRoot}/clientFundWithdraw/checkBillList">
            ...
            <div class="layui-inline" style="margin-bottom: 2px;">
                ...
                <label class="layui-form-label" 120px">结束日期:</label>
                <div class="layui-input-block">
            ...
            <div class="layui-inline" style="margin-bottom: 2px;">
                ...
                <div class="layui-input-block">
                    <tag:select id="remittanceType" name="remittanceType" nameKey="FUND_WITHDRAW_REMITTANCE_TYPE"
                                isAddDefaltOption="true" initSelectedKey="${params.remittanceType}"
            ...
            <div class="layui-form-item" style="padding: 10px 50px;">
                ...
                <button class="layui-btn layui-btn-radius layui-btn-warm " style="float: left;margin-right: 10px"
                        type="button" onclick="goPassBillBatchView();"><i
                        class="layui-icon ">&#x1005;</i>批量汇款成功
                </button>
