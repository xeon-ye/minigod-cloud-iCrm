...
<div class="main-container" id="main-container">
    <div class="" style="margin-top: 10px;">
        <form class="layui-form" id="search-from" method="post"
              action="${webRoot}/clientFundWithdraw/checkRemList">
            ...
            <div class="layui-form-item" style="padding: 10px 50px;">
                ...
                <shiro:hasPermission name="clientFundWithdraw:expDealList">
                    <button class="layui-btn layui-btn-danger" type="button" id="export"
                            onclick="expDealList()"><i class="layui-icon">&#xe601;</i>导 出
                    </button>
                </shiro:hasPermission>
                <button class="layui-btn layui-btn-radius layui-btn-warm " style="float: left;margin-right: 10px"
                        type="button" onclick="goPassRemBatchView();"><i
                        class="layui-icon ">&#x1005;</i>批量提交
                </button>
                <button class="layui-btn layui-btn-radius layui-btn-normal " style="float: left;margin-right: 10px"
                        type="button" onclick="goPrintChequeView();"><i
                        class="layui-icon ">&#xe601;</i>打印支票
                </button>
            ...
            <table id="table-list" class="layui-table" lay-size="">
                ...
                <c:forEach items="${page.result}" var="info" varStatus="i">
                    <tr name="${info.id }">
                        ...
                        <c:if test="${params.flag == 2}">
                            <td>
                                    ${fns:getCodeName("FUND_WITHDRAW_REMITTANCE_TYPE", info.remittanceType)}
                            </td>
                        </c:if>
                        <td>
...
//        setTimeout(refresh, 6000);
    ...
    function goPassRemBatchView() {
        ...
        var url = "${webRoot}/clientFundWithdraw/goPassRemBatchView?" + params;
    ...
    function goPassBillBatchView() {
        ...
        var url = "${webRoot}/clientFundWithdraw/goPassBillBatchView?" + params;
    ...
    function goPrintChequeView() {
        ...
        var url = "${webRoot}/clientFundWithdraw/goPrintChequeView?" + params;
