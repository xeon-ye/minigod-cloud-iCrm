...
<div class="main-container" id="main-container">
    ...
    <div id="div7" v-cloak>
        <div v-show="!showList" class="panel panel-default">
            <div class="panel-heading"><b style="color: #368763">请选择出金银行</b></div>
            <div class="row" style="margin-top: 20px;">
                <form class="layui-form" id="search-from" method="post"
                      action="${webRoot}/clientFundWithdraw/goPassBillBatchView?busId=${taskDto.busId}&taskId=${taskDto.taskId}&defId=${taskDto.defId}&instanceId=${taskDto.instanceId}&applicationIds=${applicationIds}">
            ...
            <div class="row">
                <div class="col-xs-12" style="width:99%" lay-size="">
