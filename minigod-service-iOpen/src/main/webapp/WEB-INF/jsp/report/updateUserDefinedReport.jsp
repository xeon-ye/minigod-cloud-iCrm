...
<div class="col-sm-12" id="main-container">
            ...
            <div v-show="!showList" class="panel panel-default">
                    ...
                    <div class="form-group col-sm-12 col-md-12">
                        ...
                        <div class="col-sm-11">
                           <span class="col-xs-6 block input-icon input-icon-right">
                                <input name="defDesc" id="defDesc" type="text" class="form-control" value="${info.defDesc}" placeholder="请输入描述" <c:if test="${type == 0}">readonly</c:if>/>
                            </span>
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-12">
                       ...
                       <span class="col-xs-12 block input-icon input-icon-right">
                             <textarea name="defSql" id="defSql" class="form-control" rows="7" style="display:inline;" placeholder="请输入SQL语句"  <c:if test="${type == 0}">readonly</c:if>>${info.defSql}</textarea>
                        </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-12">
                        ...
                        <div class="col-xs-11">
                           <span class="col-xs-6 block input-icon input-icon-right">
                                <input id="defTitle" name="defTitle" type="text" class="form-control" value="${info.defTitle}"  placeholder="请输入数据列名称"/>
                            </span>
                ...
                <div class="row">
                    <div class="form-group col-sm-6 col-md-6">
                        ...
                        <div class="col-xs-9">
                                <span class="col-xs-12 block input-icon input-icon-right">
                                    <tag:select nameKey="STATUS_EFFECTIVE_INVALID" id="isStatus" name="isStatus" initSelectedKey="${info.isStatus}" isAddDefaltOption="true"
                ...
                <div class="row" style="margin-top: 10px;margin-bottom: 10px;" align="center">
                    <button id="update" type="button" class="layui-btn ">保存</button>
    ...
    <form class="layui-form" id="search-from" action="${webRoot}/userDefinedReport/runUserDefinedSQL">
        ...
        <input name="params"  style="display: none" value="${info.params}" />
    </form>
...
<script>
    ...
    $("#update").click(function () {
        ...
        $.ajax({
            url: "${webRoot}/userDefinedReport/update",
    ...
    $("#run").click(function () {
        ...
        window.location.href = '${webRoot}/userDefinedReport/runUserDefinedSQL?userDefinedSql=&' +userDefined+"&flag=2";
