    ...
    <div class="row" style="margin-left: 20px;margin-top: 20px;">
        <div class="col-md-3 panel panel-default">
            <div style="font-size: 20px;margin-bottom: 10px">
                <i class="layui-icon" style="font-size: 20px; color: #4caf50;">&#xe62e;</i> 流程节点树
            </div>
        ...
        <div class="col-md-7 panel panel-default" style="margin-left: 100px">
            <div style="font-size: 20px;margin-bottom: 10px">
                <i class="layui-icon panel-title" style="font-size: 20px; color: #4caf50;">&#xe63c;</i> 节点信息
            </div>
                    ...
                    <form class="form-horizontal  bv-form" id="flowSetForm" action="#">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6 col-md-5 " isHide="2">
                                ...
                                <div class="col-sm-9">
											<span class="col-xs-11 block input-icon input-icon-right">
												<tag:select nameKey="act_node_action" name="nodeAction"
                                                            clazz="form-control"/>
											</span>
                                </div>
                            </div>
                            <div class="form-group col-sm-6 col-md-5 " isHide="25">
                                ...
                                <div class="col-sm-9">
											<span class="col-xs-11 block input-icon input-icon-right">
												<tag:select name="callBack" clazz="form-control" isJXdata="true"
                                                            data="${calBacks}" isAddDefaltOption="true"
                                                            defaltOptionValue="--请选择--"/>
											</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-6 col-md-5 " isHide="2">
                                <label class="col-sm-3 control-label no-padding-right"><i class="red">
                                    * </i>待办显示:</label>
                                <div class="col-sm-9">
                                            <span class="col-xs-11 block input-icon input-icon-right">
                                                <tag:select nameKey="COMMON_YES_NO" id="backLogShow" name="backLogShow" isAddDefaltOption="true"
                                                            initSelectedKey="${nodeSet.backLogShow}"
                                                            clazz="form-control" defaltOptionValue="--请选择--"/>
                                            </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div isHide="2">
                            <button class="layui-btn layui-btn-small" type="button" onclick="userWindow()"><i
                                    class="layui-icon">&#xe612;</i>审批范围
                            </button>
                        </div>
                        ...
                        <div class="row" isHide="4" id="actRules">
                            <div class="form-group col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <tag:select name="judgList[0].fieldName" clazz="form-control" isJXdata="true"
                                                    data="${judgs }" isAddDefaltOption="true"/>
                                    </div>
                                    <div class="col-sm-2" style="padding: 0px;">
                                        <tag:select name="judgList[0].rule" clazz="form-control" nameKey="act_judg"
                                    ...
                                    <div class="col-sm-2">
                                        <tag:select name="judgList[1].elOperator" clazz="form-control"
                                                    nameKey="act_el_operator" isAddDefaltOption="true"/>
                                    </div>
                            ...
                            <div class="form-group col-sm-12 ">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <tag:select name="judgList[1].fieldName" clazz="form-control" isJXdata="true"
                                                    data="${judgs }" isAddDefaltOption="true"/>
                                    </div>
                                    <div class="col-sm-2" style="padding: 0px;">
                                        <tag:select name="judgList[1].rule" clazz="form-control" nameKey="act_judg"
                                                    isAddDefaltOption="true"/>
                                    </div>
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-2">
                                        <tag:select name="judgList[2].elOperator" clazz="form-control"
                                                    nameKey="act_el_operator" isAddDefaltOption="true"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <tag:select name="judgList[2].fieldName" clazz="form-control" isJXdata="true"
                                                    data="${judgs }" isAddDefaltOption="true"/>
                                    </div>
                                    <div class="col-md-2" style="padding: 0px;">
                                        <tag:select name="judgList[2].rule" clazz="form-control" nameKey="act_judg"
                                                    isAddDefaltOption="true"/>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="row" style="margin-left: 180px;padding-bottom: 28px;margin-top: 25px;">
                            ...
                            <button class="layui-btn layui-btn-primary" type="button" onclick="closeThisWindow()">关 闭
                            </button>
                        </div>
                    </form>
                </div>
