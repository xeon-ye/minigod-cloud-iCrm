...
/**
 * @description: 资金统计导出Excel模板
 * @author: fuyy
 * @date: 2018/11/28
 * @version: v1.0
 */

public class ClientAssetFlowInfoGroupModel extends BaseRowModel {
    ...
    @ExcelProperty(value = "现金余额" ,index = 7)
    private String currentBalance;

    @ExcelProperty(value = "冻结资金" ,index = 8)
    private String frozenBalance;

    @ExcelProperty(value = "证券市值" ,index = 9)
    ...
    @ExcelProperty(value = "总资产" ,index = 10)
