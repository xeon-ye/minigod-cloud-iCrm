...
/**
 * @description: 统一用户中心请求协议
 * @author: Larry Lai
 * @date: 2018/10/17 15:17
 * @version: v1.0
 */

public class SecuritiesUserInfoProto extends BaseParameter {
    ...
    /**
     * 设置：客户状态[0-正常 1-冻结 2-挂失 3-销户 D-休眠 E-不合格 F-锁定]
     */
    public void setClientStatus(String clientStatus) {
        this.clientStatus = clientStatus;
    }
    /**
     * 获取：客户状态[0-正常 1-冻结 2-挂失 3-销户 D-休眠 E-不合格 F-锁定]
     */
    ...
    /**
     * 设置：银行账户类型[0-香港账户 1-非香港帐号]
     */
    public void setBankType(Integer bankType) {
        this.bankType = bankType;
    }
    /**
     * 获取：银行账户类型[0-香港账户 1-非香港帐号]
     */
    ...
    /**
     * 设置：所属行业[数据字典-AO_OCCUPATION_TYPE]
     */
    public void setProfessionType(Integer professionType) {
        this.professionType = professionType;
    }
    /**
     * 获取：所属行业[数据字典-AO_OCCUPATION_TYPE]
     */
    ...
    /**
     * 设置：净资产范围类型[1=<50万 2=50万-250万 3=250万-500万 4=>500万]
     */
    public void setNetCapital(Integer netCapital) {
        this.netCapital = netCapital;
    }
    /**
     * 获取：净资产范围类型[1=<50万 2=50万-250万 3=250万-500万 4=>500万]
     */
    ...
    public Date getOpenAccountStartTime() {
        return openAccountStartTime;
    }

    public void setOpenAccountStartTime(Date openAccountStartTime) {
        this.openAccountStartTime = openAccountStartTime;
    }

    public Date getOpenAccountEndTime() {
        return openAccountEndTime;
    }

    public void setOpenAccountEndTime(Date openAccountEndTime) {
