 ...
 */
@ActTable(tableName = "customer_account_open_application", pkName = "application_id")
public class CustomerAccountOpenApplyEntity extends ActivitiBaseEntity implements Serializable {
