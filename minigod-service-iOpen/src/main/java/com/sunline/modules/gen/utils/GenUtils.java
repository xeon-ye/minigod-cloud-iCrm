...
import com.sunline.modules.gen.entity.ColumnEntity;
import com.sunline.modules.gen.entity.TableEntity;
...
public class GenUtils {
	...
	public static String getLocalFileName(String template, String className, String packageName){
		StringBuffer fileOutPath = new StringBuffer();
		fileOutPath.append(config.getString("projectPath"));
		if(template.contains("Entity.java.vm")){
			fileOutPath.append(config.getString("entity")).append(File.separator).append(className).append("Entity.java");
//			return config.getString("entity") + File.separator + className + "Entity.java";
		}
		
		if(template.contains("Dao.java.vm")){
			fileOutPath.append(config.getString("dao")).append(File.separator).append(className).append("Dao.java");
//			return config.getString("dao") + File.separator + className + "Dao.java";
		}

		if (template.contains("Dao.xml.vm")) {
			fileOutPath.append(config.getString("mapping")).append(File.separator).append(className).append("Mapper.xml");
//			return config.getString("mapping") + File.separator + className + "Mapper.xml";
		}

		if (template.contains("Service.java.vm")) {
			fileOutPath.append(config.getString("service")).append(File.separator).append(className).append("Service.java");
//			return config.getString("service") + File.separator + className + "Service.java";
		}

		if (template.contains("ServiceImpl.java.vm")) {
			fileOutPath.append(config.getString("serviceImpl")).append(File.separator).append(className).append("ServiceImpl.java");
//			return config.getString("serviceImpl") + File.separator + className + "ServiceImpl.java";
		}

		if (template.contains("Controller.java.vm")) {
			fileOutPath.append(config.getString("controller")).append(File.separator).append(className).append("Controller.java");
//			return config.getString("controller") + File.separator + className + "Controller.java";
		}
		if (template.contains("list.html.vm")) {
			fileOutPath.append(config.getString("view")).append(File.separator).append(className).append(".html");
//			return config.getString("view") + File.separator + className.toLowerCase() + ".html";
		}

		if (template.contains("list.js.vm")) {
			fileOutPath.append(config.getString("js")).append(File.separator).append(className).append(".js");
//			return config.getString("js") + File.separator + className.toLowerCase() + ".js";
		}
		if (template.contains("menu.sql.vm")) {
			fileOutPath.append(config.getString("sql")).append(File.separator).append(className).append("_menu.sql");
//			return config.getString("sql") + File.separator + className.toLowerCase() + "_menu.sql";
		}
		return fileOutPath.toString();
	}
    /**
     * 获取文件名 web中生成代码使用
     */
